...
module.exports = {
  ...
  WEBHOOK_SECRET: varSource.WEBHOOK_SECRET,
  NEW_RELIC_APP_NAME: varSource.NEW_RELIC_APP_NAME, // optional, specify when using New Relic
  NEW_RELIC_LICENSE_KEY: varSource.NEW_RELIC_LICENSE_KEY, // optional, specify when using New Relic
