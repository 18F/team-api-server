...
function finishAboutYmlUpdate(updater) {
  return function(err) {
    return new Promise(function(resolve, reject) {
      ...
      if (err) {
        ...
        successMessage = updater.fullName + ': ' + module.exports.ABOUT_YML +
          ' update sucessful';
...
ProjectDataUpdater.prototype.checkForAndImportUpdates = function(info) {
  ...
  if (module.exports.isValidUpdate(info, this.gitHubOrg) &&
    ...
    done = finishAboutYmlUpdate(this);
...
ProjectDataUpdater.prototype.pullChangesAndRebuild = function() {
  var updater = this,
    ...
    if (err) {
      ...
      console.log('pullChangesAndRebuild failed:', errMsg);
    }
